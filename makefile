...
SRCS = main.cpp GameManager.cpp Gameboard.cpp SpriteManager.cpp Bitboard.cpp Entity.cpp Component.cpp Sprite.cpp Board.cpp BoardSquare.cpp Piece.cpp Clickable.cpp 
OBJS = GameManager.o Gameboard.o SpriteManager.o Bitboard.o Entity.o Component.o Sprite.o Board.o BoardSquare.o Piece.o Clickable.o 
MAIN = checkers
...
Piece.o: Piece.h Piece.cpp Entity.o Clickable.o
	$(CC) $(CFLAGS) -c Piece.cpp 

Board.o: Board.h Board.cpp Entity.o BoardSquare.o
	$(CC) $(CFLAGS) -c Board.cpp

BoardSquare.o: BoardSquare.h BoardSquare.cpp Entity.o Clickable.o
...
Clickable.o: Component.o Clickable.cpp Clickable.h
	$(CC) $(CFLAGS) -c Clickable.cpp
